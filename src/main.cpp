...
void setup() {
  ...
  EPD_2IN13B_V3_Init();                    // init (retorna void en esta lib)
  ...
  UWORD W = EPD_2IN13B_V3_WIDTH;   // 212
  UWORD H = EPD_2IN13B_V3_HEIGHT;  // 104
  ...
  EPD_2IN13B_V3_Display(BlackImage, RedImage);
  wait_ms(1500);
